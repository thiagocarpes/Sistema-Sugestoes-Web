...
<body>
    <div class="container-fluid">
        <div class="top">
            <div class="limitHome">
                <div class="col-md-9"><div id="tituloHome">Ranking</div></div>
    ...
    <div class="limitHome">
        <div class="conteudoCadastro">
        	...
        	<c:if test="${not empty listaParticipacaoCategoria}">
                <div id="list" class="row">
                    ...
                    <div class="table-responsive col-md-12">
                        <table class="table table-striped" cellspacing="0" cellpadding="0">
                            ...
                            <tbody>
          					<c:forEach var="sugestao" items="${listaParticipacaoCategoria}">
                                       <tr>
                                            <td>
